...
// This version saves the file using the 
// PDF Library, so that (1) it is perfectly
// smooth, and (2) so that I can edit 
// the file inside Illustrator.
// When I use the regular renderer
// (called P2D), it is saved as a 
// PNG or JPG file, both lossy formats,
// making subsequent editing less
// useful.

import processing.pdf.*;

void setup() {
  size(500, 500,PDF,"TheGame.PDF");
  background(#110A0F);
  fill(#FEFDFC);
  noStroke();
